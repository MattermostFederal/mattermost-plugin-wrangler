...
// Force newer server/v8 to address critical/high CVEs in indirect dependency
replace github.com/mattermost/mattermost/server/v8 => github.com/mattermost/mattermost/server/v8 v8.0.0-20260205143235-22e4e9c171dc
